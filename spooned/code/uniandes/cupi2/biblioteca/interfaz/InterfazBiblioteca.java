package code.uniandes.cupi2.biblioteca.interfaz;
...
public class InterfazBiblioteca extends javax.swing.JFrame {
     ...
     */
    private code.uniandes.cupi2.biblioteca.mundo.IFabricaBiblioteca fabrica;
    
    /** 
     * Interfaz de la clase principal del mundo.
     */
    private code.uniandes.cupi2.biblioteca.mundo.AbstractBiblioteca biblioteca;
     ...
     */
    private code.uniandes.cupi2.biblioteca.interfaz.PanelImagen panelImagen;
    
    /** 
     * Scroll donde está la lista de libros.
     */
    private code.uniandes.cupi2.biblioteca.interfaz.PanelLibros panelLibros;
    
    /** 
     * Panel donde están ubicadas las acciones.
     */
    private code.uniandes.cupi2.biblioteca.interfaz.PanelAccionesContenedora panelAccionesContenedora;
    ...
    public InterfazBiblioteca() {
        try {
            fabrica = new code.uniandes.cupi2.biblioteca.mundo.implementacion1.FabricaBiblioteca();
            loginUsuario = "";
            biblioteca = fabrica.darBiblioteca("./data/bibliotecaLibros.data" ,"./data/bibliotecaUsuarios.data");
            biblioteca.cargar();
        } catch (code.uniandes.cupi2.biblioteca.mundo.excepciones.CargarBibliotecaException e) {
        ...
        panelImagen = new code.uniandes.cupi2.biblioteca.interfaz.PanelImagen();
        panelPrincipal.add(panelImagen ,gridBagConstraints);
        panelLibros = new code.uniandes.cupi2.biblioteca.interfaz.PanelLibros(this);
        panelPrincipal.add(panelLibros ,gridBagConstraints12);
        panelAccionesContenedora = new code.uniandes.cupi2.biblioteca.interfaz.PanelAccionesContenedora(this);
     ...
     */
    public void registrarUsuario(java.lang.String login, java.lang.String contrasenia, java.lang.String nombre) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.UsuarioPreexistenteException {
     ...
     */
    public void insertarCopiaLibro(java.lang.String referencia) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.LibroInexistenteException {
    ...
    public void buscarTituloPorPalabra(java.lang.String[] datos) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorTitulo(datos);
    ...
    public void buscarTituloExacto(java.lang.String titulo) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorTituloExacto(titulo);
        panelLibros.actualizarListaBusqueda(libros);
    }
    ...
    public void buscarAutoresPorPalabra(java.lang.String[] datos) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorAutores(datos);
        panelLibros.actualizarListaBusqueda(libros);
    }
    ...
    public void buscarAutoresExacto(java.lang.String datos) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorAutoresExacto(datos);
        panelLibros.actualizarListaBusqueda(libros);
    }
    ...
    public void buscarDescriptoresPorPalabra(java.lang.String[] datos) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorDescriptores(datos);
        panelLibros.actualizarListaBusqueda(libros);
    }
    ...
    public void buscarDescriptoresExacto(java.lang.String[] datos) {
        uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  libros = biblioteca.buscarPorDescriptoresExacto(datos);
        panelLibros.actualizarListaBusqueda(libros);
    }
     ...
     */
    public void alquilar(java.lang.String libro) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.CopiasInsuficientesException {
     ...
     */
    public void borrarDevuelto(code.uniandes.cupi2.biblioteca.interfaz.PanelLibroAlquilado panelLibroAlquilado) {
    ...
    public static void main(java.lang.String[] args) {
        javax.swing.SwingUtilities.invokeLater(new java.lang.Runnable() {
            public void run() {
                code.uniandes.cupi2.biblioteca.interfaz.InterfazBiblioteca thisClass = new code.uniandes.cupi2.biblioteca.interfaz.InterfazBiblioteca();
