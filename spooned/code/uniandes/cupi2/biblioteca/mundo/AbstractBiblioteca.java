 ...
 */
@annotation.Feature(featureName = "Inventario", mandatory = false)
public abstract class AbstractBiblioteca extends java.util.Observable {
     ...
     */
    public abstract void insertarUsuario(java.lang.String login, java.lang.String clave, java.lang.String nombre) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.UsuarioPreexistenteException;
     ...
     */
    @code.OptionFeature(featureName = "AgregarLibro", mandatory = true)
    public abstract void insertarLibro(java.lang.String titulo, java.lang.String[] autores, java.lang.String[] descriptores, int ejemplares, java.lang.String ref) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.LibroYaExisteException;
     ...
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorTituloExacto(java.lang.String titulo);
     ...
     * @return Libros que cumplen con los parámetros de búsqueda.
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorTitulo(java.lang.String[] datos);
     ...
     * @return Libros que cumplen con los parámetros de búsqueda.
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorAutoresExacto(java.lang.String autor);
     ...
     * @return Libros que cumplen con los parámetros de búsqueda.
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorAutores(java.lang.String[] datos);
     ...
     * @return Libros que cumplen con los parámetros de búsqueda.
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorDescriptoresExacto(java.lang.String[] datos);
     ...
     * @return Libros que cumplen con los parámetros de búsqueda.
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorDescriptores(java.lang.String[] datos);
     ...
     */
    public abstract void alquilarLibro(java.lang.String usuario, java.lang.String referencia) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.CopiasInsuficientesException;
     ...
     */
    public abstract uniandes.cupi2.collections.iterador.Iterador<code.uniandes.cupi2.biblioteca.mundo.ILibro>  darAlquilados(java.lang.String usuario);
     ...
     */
    @code.OptionFeature(featureName = "CantidadDeLibros", mandatory = false)
     ...
     */
    public abstract code.uniandes.cupi2.biblioteca.mundo.ILibro darLibro(java.lang.String ref);
     ...
     */
    @code.OptionFeature(featureName = "AgregarCopiaLibro", mandatory = false)
    public abstract void agregarCopia(java.lang.String referencia) throws code.uniandes.cupi2.biblioteca.mundo.excepciones.LibroInexistenteException;
    
    /** 
     * Salva la información de la biblioteca.
     * @throws SalvarBibliotecaException Si no se puede salvar la biblioteca.
     */
    public abstract void salvar() throws code.uniandes.cupi2.biblioteca.mundo.excepciones.SalvarBibliotecaException;
    
    /** 
     * Carga la información de la biblioteca.
     * @throws CargarBibliotecaException Si no se puede cargar los datos de la biblioteca.
     */
    public abstract void cargar() throws code.uniandes.cupi2.biblioteca.mundo.excepciones.CargarBibliotecaException;
