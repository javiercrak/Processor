 ...
 */
@Feature(featureName="Libro",mandatory=true)
public class Libro implements ILibro
{
     ...
     */
    @OptionFeature(featureName="CopiasEnPrestamos")
     ...
     */
    @OptionFeature(featureName="Referencia")
     ...
     */
    @OptionFeature(featureName="Titulo")
     ...
     */
    @OptionFeature(featureName="Autores")
