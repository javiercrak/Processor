 ...
 */
@Feature(featureName="ServicioUsuario",mandatory=true)
public class Usuario implements IUsuario, Serializable
{
     ...
     */
    @OptionFeature(featureName="LibrosAlquilados", mandatory=true)
     ...
     */
    @OptionFeature(featureName="AlquilarLibro", mandatory=true)
