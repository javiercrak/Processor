 ...
 */
@Feature(featureName="Inventario",mandatory=false)
public abstract class AbstractBiblioteca extends Observable
{
     ...
     */
	@OptionFeature(featureName="AgregarLibro",mandatory=true)
     ...
     */
    @OptionFeature(featureName="CantidadDeLibros",mandatory=false)
     ...
     */
    @OptionFeature(featureName="AgregarCopiaLibro",mandatory=false)
